    ...
    this.runCode =
        new JButton(
            MaterialImageFactory.getInstance()
                .getImage(MaterialIconFont.PLAY_ARROW, MaterialColors.COSMO_GREEN));
    this.stopCode =
        new JButton(
            MaterialImageFactory.getInstance()
                .getImage(MaterialIconFont.STOP, MaterialColors.COSMO_RED));
    this.consoleCode =
        new JButton(
            MaterialImageFactory.getInstance()
                .getImage(MaterialIconFont.CODE, MaterialColors.ORANGE_500));
