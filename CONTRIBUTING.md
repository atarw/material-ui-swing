...
* Make sure you run `.gradlew googleJavaFormat`.
* Make sure that Github action is happy.
* Don't add any new dependencies.
* Write properly formatted git commits (see below).
* If you don't know where to start, look to the good first issue, or [open a discussion](https://github.com/vincenzopalazzo/material-ui-swing/discussions)
